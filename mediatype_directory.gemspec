...
Gem::Specification.new do |s|
  ...
  s.homepage        = "https://github.com/JamesLavin/MediatypeDirectory"
  s.summary         = %q{Creates directory of softlinks for all files with specified mediatype in subdirectory tree}
